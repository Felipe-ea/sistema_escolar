    ...
    <div class="bg-gray-100 p-6">
        <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
            ...
            <form action="aluno.php" method="POST" class="mt-4">
                ...
                <button type="submit" name="action" value="cadastrar" class="w-full mt-4 p-2 text-white bg-green-500 rounded-lg hover:bg-green-600">Cadastrar</button>
                <button type="submit" name="action" value="editar" class="w-full mt-2 p-2 text-white bg-yellow-500 rounded-lg hover:bg-yellow-600">Editar</button>
            </form>
            
            <!-- Lista de Alunos -->
            <div class="mt-6">
                <h3 class="text-xl font-semibold text-gray-700">Lista de Alunos</h3>
