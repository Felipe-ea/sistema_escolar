...
<div class="bg-gray-100 p-4">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-2xl font-bold text-gray-700 text-center">Gerenciar Professores</h2>
        
        <form action="../controller/cadastrarProfessor.php" method="POST" class="mt-4">
            ...
            <label class="block mt-3">
                ...
                <input type="text" name="disciplina" class="w-full mt-1 p-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-500" required>
            </label>
        ...
        <div class="mt-6">
            <hr>
            <h3 class="py-4 justify-self-center text-xl font-semibold text-gray-700">Lista de Professores</h3>
            <table class="w-full mt-2 bg-white border rounded-lg">
                ...
                <tbody>
                    ...
                    $sql_consulta = "SELECT * FROM professor";
                    ...
                    <tr>
                        ...
                        <td class="p-2 border text-center">
                            <form action="controller/acoes.php" method="POST">
                                <button name="editarProfessor" value="<?= $consulta['id'] ?>" class="bg-yellow-500 text-white px-2 py-1 rounded hover:bg-yellow-600">Editar</button>
                                <button name="deletarProfessor" value="<?= $consulta['id'] ?>" class="bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600">Excluir</button>
                            </form>
                        </td>
                    </tr>
